...
<table class="talenttable">
  ...
  <tr>
    <td>
      <a href="assets/img/simulink.png" data-lightbox="image-1" data-title="This is a Simulink model I built to assist in the design of my shape memory alloy actuator. The heart of the model is a system of opposing springs, and I'm tracking the position where the springs connect. Simulink is helpful, for example, because the behavior of the Nitinol spring is very complex and is dependent upon position, time, and temperature. The model allows me to optimize design parameters before spending too much time on the build itself.">Dynamics simulation<br><img src="assets/img/simulink_small.png"></a>
    </td>
    <td>
